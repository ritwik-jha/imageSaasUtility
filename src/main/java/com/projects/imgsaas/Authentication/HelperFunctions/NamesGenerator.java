package com.projects.imgsaas.Authentication.HelperFunctions;

import java.util.Random;

public class NamesGenerator {
    static final private String[] left = new String[]{
        "admiring",
		"adoring",
		"affectionate",
		"agitated",
    ...
    static final private String[] right = new String[]{
    ...
    static public String generateRandomNames(){
        Random rand = new Random();

        String name = left[rand.nextInt(left.length)] + "-" + right[rand.nextInt(right.length)] + "-" + rand.nextInt(10);
